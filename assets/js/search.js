...
var documents = [{
    ...
    "id": 7,
    "url": "https://dgr1026.github.io/mrc/2018/08/08/NAVER_Techtalk.html",
    "title": "어떻게 해야 기계에게 글을 잘 읽고 말할 수 있게 할까?",
    "body": "2018/08/08 -            발표일: 2018. 7. SQuAD가 공개되고 널리 알려지면서 기계독해(Machine Reading Comprehension)가 각광받기 시작했습니다. SQuAD란 스탠포드대에서 만든, 기계가 주어진 문서를 읽고 그와 관련된 질문을 할 경우 정답을 찾아 답해주는 시스템을 위한 데이터셋을 뜻합니다. 이러한 기계독해가 어떻게 작동하는지, 어떻게 접근해야 이해를 돕게 할 수 있고 어떻게 해야 대답을 잘 할 수 있게 하는지에 대한 경험에 대해 이야기해 보고자 합니다. 발표 슬라이드: [link]"
    }];
